...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.pref_tempUnits_key),
                mContext.getString(R.string.pref_tempUnits_metric));

        if (unitType.equals(mContext.getString(R.string.pref_tempUnits_imperial))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.pref_tempUnits_metric))) {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if(locationCursor.moveToFirst()){
            ...
            //Now that the content providder is set up, inserting rows od data is pretty simple
            //First create a ContenValues object to hold the data you want to insert.
